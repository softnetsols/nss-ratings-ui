            ...
            <div class="plan-section">
              <div class="plan-desc">
                {{ selectedSignal.direction === 'bullish' 
                   ? 'Entry is based on trigger price. Stop is below recent support (lows / AlphaTrend line). Target 2 is the main exit price.' 
                   : 'Entry is based on trigger price. Stop is above recent resistance (highs / AlphaTrend line). Target 2 is the main cover price.' 
                }}
              </div>
              ...
              <div class="plan-rules" style="margin-top: 16px;">
                ...
                <ul style="margin: 0; padding-left: 18px; font-size: 0.8rem; color: #9ca3af; line-height: 1.45;">
                  ...
                  <li *ngIf="selectedSignal.direction === 'bullish'">Trail remaining shares using AlphaTrend. Exit remaining if opposite bearish crossover triggers or stop is hit.</li>
                  ...
                  <li *ngIf="selectedSignal.direction === 'bearish'">Trail remaining shares using AlphaTrend. Exit remaining if opposite bullish crossover triggers or stop is hit.</li>
                </ul>
              </div>
            </div>
          </div>
